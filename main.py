...
parser.add_argument('--data', type=str, default=r'/home/sonic/pkd/val_datasets/RAF-DB')
parser.add_argument('--data_type', default='RAF-DB', choices=['RAF-DB', 'AffectNet-7', 'CAER-S','face'],
...
parser.add_argument('--lr', '--learning-rate', default=0.0001, type=float, metavar='LR', dest='lr')
...
parser.add_argument('--model', default='vit_base_patch16_224', type=str, metavar='MODEL',  help='Dropout rate (default: 0.)')
...
def main():
    ...
    model = biformer.biformer_base(pretrained=False)
    ...
    wandb.login(
        key="513263fcc08f655b1e8783846de19706ed284783"
    )
    wandb.init(
        project="VIT16-224",
...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        for i, (images, target) in enumerate(val_loader):
            ...
            #print('im_re_label',im_re_label)
            im_pre_label = np.array(output)
            #print('im_pre_label',im_pre_label)
